...
> Fonte: paper metodologici originali (t-SNE: van der Maaten & Hinton 2008, *JMLR*; UMAP: McInnes, Healy & Melville 2018, arXiv; PaCMAP: Wang, Huang, Rudin & Shaposhnik 2021, *JMLR*) + un paper del corpus NEMESIS che applica t-SNE su dati di disconnessione da stroke (`assets/papers/Thiebaut de Schotten et al - 2020 - .../markdown/_full.md`) — usato qui come precedente diretto per l'interpretazione, non solo come fonte dei parametri. Panoramica più ampia (metodi non usati nel progetto): [dimensionality_reduction_methods.md](dimensionality_reduction_methods.md).
