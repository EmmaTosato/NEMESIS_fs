# clinical_connectome dim_reduction (umap) — 11-08-26 20:37
...
```json
{
  ...
  "viz_n_components": 2,
  "run_notes": "first production of dimensionality reduction after specialized tuning - metric=dice, n_components=10"
}
```
...
Params used: {"n_neighbors": 30, "min_dist": 0.0, "n_components": 10, "random_state": 0, "metric": "dice"}
