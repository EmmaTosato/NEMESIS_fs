...
- Doc: `docs/guides/clustering.md`/`dim_reduction_clustering.md`, `docs/dev/analysis.md`, `docs/methods/clustering.md`, `docs/knowledge/clustering_tuning_guide.md` (silhouette plot + hdbscan), `docs/experiments/dim_reduction_clustering/tuning_dim_clustering_s1.1.md` (sezione 29-07 riscritta con numeri freschi)
...
**Obiettivo**: implementare uno step opzionale di regressione del volume lesionale sull'embedding (`regress_out_volume`) in `dim_reduction.py`/`dim_reduction_clustering.py`, seguito da un check di allineamento con la letteratura del gruppo (`papers/`) su quali altri step aggiungere pre/post riduzione dimensionale e nel clustering.
...
- **Check letteratura (`papers/`) per i prossimi step di dim reduction/clustering**, su richiesta esplicita dell'utente — verificato cosa è davvero citabile nella libreria del progetto, non proposto a memoria:
