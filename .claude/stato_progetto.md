...
- **`assets/metadata/*.tsv`**: verificati e puliti al 100% (Check A/B/C, 02-09-26) — rigenerati da `notebooks/exploration/dataset_exploration.ipynb` (ora con `dtype=str`), nessun drift residuo.
