...
|**Lesioni sintetiche (random, size/lateralization-matched)**|Thiebaut de Schotten 2020|K-means clustering su coordinate voxel per generare >1 milione di lesioni sintetiche|Gruppo di controllo per isolare l'effetto della distribuzione non casuale delle lesioni reali|

## 2. Metodi di riduzione dimensionale / embedding

|Metodo|Paper|Dati di input|Obiettivo|
|---|---|---|---|
|**PCA (varimax-rotated)**|Thiebaut de Schotten 2020, Talozzi 2023, Corbetta 2015, Corbetta 2018, Bisogno 2021, Facchini 2023, Salvalaggio 2020, Cinetto|Mappe di lesione/SDC parcellizzate; punteggi comportamentali|Comprimere alta dimensionalità in componenti principali interpretabili, sia lato imaging che lato comportamento|
...
|**UMAP**|Talozzi 2023|SDC parcellizzata|Creare un morfospazio 2D compresso su cui allenare modelli predittivi (DSD)|
...
|Metodo|Paper|Dati di input|Obiettivo|
|---|---|---|---|
|**Trattografia probabilistica whole-brain (10M streamline, SIFT2)**|Pini 2026|DWI|Ricostruire il connettoma strutturale individuale|
|**Trattografia HCP a 7T (163-842 soggetti sani)**|Thiebaut de Schotten 2020, Talozzi 2023, Griffis 2020, Cinetto|DWI di soggetti sani, usata come riferimento per proiettare le lesioni|Fungere da atlante di riferimento per stimare la SDC senza bisogno di DWI del paziente|
...
|Metodo|Paper|Dati di input|Obiettivo|
|---|---|---|---|
|**Ridge Regression**|Siegel 2016, Corbetta 2015, Bisogno 2021, Salvalaggio 2020, Facchini 2023, Cinetto|Voxel di lesione/SDC o feature di rete|Predire punteggi comportamentali individuali da mappe ad alta dimensionalità, quantificando varianza spiegata (R²)|
...
|**Regressione multipla (nel morfospazio UMAP)**|Talozzi 2023|Coordinate PCA nel morfospazio|Predire punteggi neuropsicologici a 1 anno|
...
|**Random Forest**|Idesis 2023|Feature nello spazio source vs spazio latente AE|Classificare pazienti/controlli e predire recupero a 1 anno|
...
|**Validazione Leave-One-Out (LOO-CV)**|Corbetta 2015, Salvalaggio 2020, Bisogno 2025|Modelli predittivi lesione/SDC|Stimare la performance predittiva su dati non visti con campioni piccoli|
|**PLSR (Partial Least Squares Regression)**|Griffis 2019, Griffis 2020|Danno locale vs SDC come predittori di FC|Confrontare quale rappresentazione del danno spiega meglio le alterazioni funzionali|
|**PLSC (Partial Least Squares Correlation)**|Griffis 2019|Matrici di disconnessione e di FC insieme|Estrarre componenti latenti condivise tra struttura e funzione (covarianza multivariata)|
...
|**Repeated Spectral Clustering (RSC)**|Zanola 2026|Differenze assolute nei tassi di recupero NIHSS tra pazienti|Identificare traiettorie di recupero (fenotipi) guidate dai dati, superando la dicotomia fitters/non-fitters|
|**Consensus clustering** _(menzionato come approccio futuro, non nei paper stessi)_|—|—|—|
...
|**Residualizzazione per covariate (età, sesso, volume lesione)**|Santoro 2026|Matrici FC|Rimuovere effetti di confondimento prima dell'analisi di rete|
...
|**Reti "vascolari" da correlazione spaziale delle forme d'onda HRF**|Volpi 2025|HRF deconvolute per regione|Costruire un grafo di connettività basato sulla vascolarizzazione, non sull'attività neurale|
...
|**ANOVA a tre vie (repeated measures)**|Griffis 2020|FC per categorie di connessione (diretta/indiretta, spared/disconnected)|Confrontare l'effetto di più fattori categoriali sulla FC|
...
|**Parcellizzazione Gordon** (324 regioni)|Griffis 2019, Griffis 2020|Corticale|Costruire il connettoma strutturale/funzionale|
|**Atlante trattografico HCP-842**|Griffis 2020|Connettoma di riferimento (842 soggetti sani)|Stimare connessioni strutturali dirette/indirette|
