...
|---|---|
| `2` | Come oggi: `cluster_plot.png`, `silhouette_plot.png`, confronto statico e interattivo — invariati, si disegna direttamente su `X`. |
