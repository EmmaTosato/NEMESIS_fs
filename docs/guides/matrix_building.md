...
3. `non_constant_mask.npy`: La pipeline elimina intelligentemente i voxel in cui *nessun paziente ha mai avuto una lesione* (voxel costantemente a 0). Questo file ricorda quali sono i voxel "sopravvissuti".
