...
Il tuning degli iperparametri di *dim reduction* (UMAP `n_neighbors`/`metric`, t-SNE `perplexity`) è documentato a parte in [`tuning_dim_s1.1.md`](tuning_dim_s1.1.md) — questo file copre solo il tuning dei metodi di *clustering*.
