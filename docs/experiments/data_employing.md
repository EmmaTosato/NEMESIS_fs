...
flowchart LR
    ...
    subgraph COL1["Dim Reduction — Tuning"]
        direction TB
        T11["03/04-08 + 13-08<hr/>UMAP nc2/3/5/10<br/>t-SNE nc2"]
        T12["26-08<hr/>UMAP nc2/3<br/>t-SNE nc2"]
        T21["28-08<hr/>UMAP nc2/3<br/>t-SNE nc2"]
    end

    subgraph COL2["Dim Reduction — Production"]
        direction TB
        P11["11-08 UMAP nc2/nc10<hr/>13-08 UMAP nc3<br/>28-08 t-SNE nc2"]
        P12["28-08<hr/>UMAP nc2/nc3/nc10<br/>t-SNE nc2"]
        P21["31-08<hr/>UMAP nc2<br/>UMAP nc3<br/>t-SNE nc2"]
    end

    subgraph COL3["Clustering — Tuning"]
        direction TB
        CT11["31-08<hr/>UMAP nc2/nc3/nc10<br/>(6 embedding)"]
        CT12["01-09<hr/>UMAP nc2 euclidean"]
        CT21["01-09<hr/>UMAP nc2 euclidean"]
    end

    subgraph COL4["Clustering — Production"]
        direction TB
        CP11["01-09<hr/>UMAP nc2 euclidean<br/>6 opzioni k"]
